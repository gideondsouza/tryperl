Ext.define('TryPerlIde', {
	...
	},
	{
	    ...
	    },
		{
			...
			layout : 'fit',
	        //finally finally! Panel is the one to work!!
	        items: [{ xtype: 'textarea', maxLength:1024*10, maxLengthText:'MaxLength is 10KB of text', value: 'Anything here will be passed into your programs STDIN', id: 'stdin_txt'}]
		}]
	}]
